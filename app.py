...
# Register AI Interview Blueprint
...
def job_posting():
    return send_file('templates/job-posting.html')

@app.route('/candidates')
def candidates():
    return send_file('templates/candidates.html')

@app.route('/scheduling')
def scheduling():
    return send_file('templates/scheduling.html')
...
def ai_interview_demo():
    return send_file('templates/ai_interview_demo.html')
